  ...
  >
    ...
    <div class="space-y-0 divide-y divide-gray-800 text-sm text-gray-200 max-w-4xl w-full mx-auto">
      ...
      >
        ...
        <span class="font-medium text-white">{contentData.title || "(No Title)"}</span>
      </div>
      ...
      >
        ...
        <span class="font-medium text-white">{contentData.form_count}</span>
      </div>
      ...
      >
        ...
        {:else}
          <span class="text-green-400 font-medium flex items-center gap-1">None Detected</span>
        {/if}
      </div>
            ...
            {#each contentData.forms as form, i}
              ...
              >
                ...
                >
                  ...
                  {:else}
                    <span class="text-green-400 font-medium">✅ Submits to Same Domain</span>
                  {/if}
                </div>
            ...
            {#each contentData.iframes as iframe, i}
              ...
              >
                ...
                >
                  ...
                  <span class="font-mono text-white break-all">{iframe.src || "(No Source)"}</span>
                </div>
