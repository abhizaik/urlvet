<script lang="ts">
  import type { PhishingResult, SSLInfo, TLSInfo } from "../../types";
...
{#if sslInfo || tlsInfo || phishing}
  ...
  >
    ...
    {#if phishing}
      <div
        class="mb-5 rounded-lg border {phishing.in_database && phishing.valid
          ? 'border-red-700/60 bg-red-950/20'
          : 'border-gray-700 bg-gray-800/30'} p-4"
      >
        <!-- Block header -->
